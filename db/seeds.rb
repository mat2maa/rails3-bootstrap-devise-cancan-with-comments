...
Role.create({:name => ENV['ROLE_ADMIN']}, :without_protection => true)
Role.create({:name => ENV['ROLE_REP']}, :without_protection => true)
Role.create({:name => ENV['ROLE_USER']}, :without_protection => true)
Role.create({:name => ENV['ROLE_GUEST']}, :without_protection => true)
